...
def test_model():
    ...
    #===============================================
    # Add classification report to tensorboard
    #===============================================
    cls_report = classification_report(y_true, y_predicted, target_names=class_names)
    print(cls_report)
    writer.add_text("classification_report", cls_report)
